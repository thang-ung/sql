...
namespace SQLBoost.TSQL.Master.Aggregates{
	...
	public class Json16 : IBinarySerialize	//same as Json but handles more arguments
	{
		/// <summary>
		...
		public void Accumulate(string format ="value:\"{0}\"", string val00 =null,
			...
			try{
				_sb.Add(string.Format(new NullFmt(), format, val00,
						val01, val02, val03,
						val04, val05, val06,
						val07, val08, val09,
						val10, val11, val12,
		...
		public void Merge(Json16 other){
